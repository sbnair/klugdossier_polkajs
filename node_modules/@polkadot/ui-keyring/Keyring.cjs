...
var _chains = require("@polkadot/ui-settings/defaults/chains");
...
class Keyring extends _Base.Base {
  ...
  allowGenesis(json) {
    if (json && json.meta && this.genesisHash) {
      const hashes = Object.values(_chains.chains).find(hashes => hashes.includes(this.genesisHash || '')) || [this.genesisHash];
